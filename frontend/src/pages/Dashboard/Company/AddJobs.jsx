...
export default function AddJobs() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('https://menjadi-bintang-server.vercel.app/api/v1/job/add', data, {
        headers: {
      ...
      console.error('Error uploading portofolio:', error);
      let errorMessage = 'Failed to add portofolio.';
  ...
  return (
    <Authenticated>
      <div className="card p-4">
        <h4 style={{ marginBottom: '0px' }}>Add New Jobs</h4>
        <hr />
